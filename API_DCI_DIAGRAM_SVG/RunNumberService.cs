...
using EKBPartStock.model;
using Microsoft.Data.SqlClient;

namespace EKBPartStock.service.runningNumber
{
    public class RunNumberService
    {
        private SqlConnectDB runNbrTba = new SqlConnectDB("dbSCM");
        public string NextId(string key)
        {
            ...
            runNbrTba.ExecuteCommand(sqlUpdate);
        ...
        public RunningNumber LoadUnique(string key)
        {
            try
            {
                ...
                DataTable tb = runNbrTba.Query(sqlSelect);
