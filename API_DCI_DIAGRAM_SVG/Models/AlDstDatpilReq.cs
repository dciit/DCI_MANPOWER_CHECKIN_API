...
{
    public partial class AlDstDatpilReq
    {
        ...
        public string? AppMgBy { get; set; }
        public DateTime? AppMgDate { get; set; }
        public string? AppGmBy { get; set; }
        public DateTime? AppGmDate { get; set; }
        public string? ConfirmBy { get; set; }
        public DateTime? ConfirmDate { get; set; }
        public string? Remark { get; set; }
        public string? DciLotno { get; set; }
        public string? PrdLotno { get; set; }
        public decimal? ReturnLineQty { get; set; }
        public decimal? ReturnNgQty { get; set; }
        public string? ReturnBy { get; set; }
        public DateTime? ReturnDate { get; set; }
        public string? ReturnConfBy { get; set; }
        public DateTime? ReturnConfDate { get; set; }
