...
{
    public partial class LogCimfileDo
    {
        public string IdentNo { get; set; } = null!;
        public string? IdentSet { get; set; }
        public int? DryId { get; set; }
        public string? VdAddr { get; set; }
        public string? VdSort { get; set; }
        public int? RevTime { get; set; }
        ...
        public string? RndMonth { get; set; }
        public string? RndYear { get; set; }
        ...
        public decimal? RndTotal { get; set; }
